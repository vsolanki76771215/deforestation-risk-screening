"""Train the Task 3.14 expanded-data CPU Random Forest baseline.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--config", default="config/baseline_model_task_3_14.yaml")
...
def main() -> int:
    ...
    if existing and not args.overwrite:
        raise FileExistsError(f"Task 3.14 baseline output exists; pass --overwrite to replace it: {existing}")
    ...
    result = {
        "task": "3.14-baseline", "status": "COMPLETED", "model_type": model_cfg["type"],
    ...
    print("Task 3.14 baseline training: COMPLETED")
    return 0

"""Validate Task 3.14 expanded-data baseline artifacts and leakage controls."""
...
def main() -> int:
    ...
    if missing:
        result = {"task": "3.14-baseline", "status": "FAILED", "checks": checks, "errors": errors}
    ...
    result = {
        "task": "3.14-baseline", "status": "PASSED" if not errors else "FAILED",
    ...
    print(f"Validation summary: {output_path}")
    print(f"Task 3.14 baseline validation: {result['status']}")
